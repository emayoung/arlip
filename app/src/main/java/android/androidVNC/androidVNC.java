...
public class androidVNC extends Activity {
	...
	public void onCreate(Bundle icicle) {
        ...
        if(action.equals("android.intent.action.MAIN")){
			...
			Toast.makeText(this, "actionID equals " + myIntent.getBooleanExtra("com.offsec.nhvnc.EXTRA_CONN_DATA", false), Toast.LENGTH_SHORT).show();
            if(actionID){
				fromIntent=true;
               // Log.d("EXTRA_CONN_DATA: ", actionID.toString());
                arriveOnPage();
				ipText.setText(myIntent.getStringExtra("R_IP"));
				Toast.makeText(this, "string extra IP Text is " + myIntent.getStringExtra("R_IP") , Toast.LENGTH_SHORT).show();
...
//        this code was modified by emem in an attempt to link the vnc component with arlip
	}
	...
	private void updateViewFromSelected() {
		...
		checkboxLocalCursor.setChecked(false);
		checkboxLocalCursor.setVisibility(View.GONE);
