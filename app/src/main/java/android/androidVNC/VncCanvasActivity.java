...
//				return vncCanvas.processPointerEvent(e, true);
//			} else
				return false; //super.onTouchEvent(e);
		}
...
//			e.setAction(MotionEvent.ACTION_UP);
			return false; //vncCanvas.processPointerEvent(e, false, multiTouch||vncCanvas.cameraButtonDown);
		}
...
//			vncCanvas.processPointerEvent(e, true, true);
//			e.setAction(MotionEvent.ACTION_UP);
			return false; //vncCanvas.processPointerEvent(e, false, true);
		}
	...
	public boolean onTouchEvent(MotionEvent event) {
		return false; //inputHandler.onTouchEvent(event);
	}
...
//			return true;
//		}
		return false; // VncCanvasActivity.super.onTouchEvent(evt);
	}
	...
	public class TouchPanTrackballMouse implements AbstractInputHandler {
		...
		@Override
		public boolean onTrackballEvent(MotionEvent evt) {
			return false; //trackballMouse(evt);
		}
...
//				return true;
			return false; //VncCanvasActivity.super.onTouchEvent(event);
		}
...
//			if (vncCanvas.processPointerEvent(event))
//				return true;
			return false; //.super.onGenericMotionEvent(event);
		}
